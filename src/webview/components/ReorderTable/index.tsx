...
interface ReorderTableProps {
  ...
  updateReorderedItem?: (...args: unknown[]) => unknown;
}
...
const ReorderTable = ({
  ...
  const rowsOrder = useMemo(() => React.Children.toArray(children) as ReactElement[], [children]);
  ...
  const handleRowHover = (index: any, hoverstatus = true) => {
  ...
  const handleDrop = (e: any, toIndex: any) => {
    e.preventDefault();
