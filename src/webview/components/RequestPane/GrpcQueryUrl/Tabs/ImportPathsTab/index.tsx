      ...
      {collectionImportPaths && collectionImportPaths.length > 0 && (
        <div className="content-wrapper">
          ...
          <div className="items-container">
            {collectionImportPaths.map((importPath: any, index: any) => {
...
interface ImportPathsTabProps {
  collectionImportPaths: unknown[];
  invalidImportPaths: string;
  onOpenCollectionProtobufSettings?: (...args: unknown[]) => void;
  onBrowseImportPath?: (...args: unknown[]) => void;
  onToggleImportPath?: (...args: unknown[]) => void;
}
