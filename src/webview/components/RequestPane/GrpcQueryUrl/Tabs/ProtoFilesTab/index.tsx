...
interface ProtoFilesTabProps {
  collectionProtoFiles: unknown[];
  invalidProtoFiles: string;
  protoFilePath?: unknown;
  collection: unknown;
  onSelectCollectionProtoFile?: (...args: unknown[]) => void;
  onOpenCollectionProtobufSettings?: (...args: unknown[]) => void;
  onSelectProtoFile?: (...args: unknown[]) => void;
}
      ...
      {collectionProtoFiles && collectionProtoFiles.length > 0 && (
        <div className="content-wrapper">
          ...
          <div className="items-container">
            {collectionProtoFiles.map((protoFile: any, index: any) => {
