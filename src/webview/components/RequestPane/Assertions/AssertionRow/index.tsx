...
interface parseAssertionOperatorProps {
  item?: React.ReactNode;
  collection?: React.ReactNode;
  assertion: unknown;
  handleAssertionChange?: (...args: unknown[]) => unknown;
  handleRemoveAssertion?: (...args: unknown[]) => void;
...
const isUnaryOperator = (operator: any) => {
  const unaryOperators = [
    'isEmpty',
    'isNotEmpty',
    'isNull',
...
const AssertionRow = ({
  ...
  return <>
    ...
    <td>
      <AssertionOperator
        operator={operator}
        onChange={(op: any) => handleAssertionChange(
          {
            target: {
