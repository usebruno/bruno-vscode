...
interface getPropertyFromDraftOrRequestProps {
  item: unknown;
 ...
 * @returns
 */
const getPropertyFromDraftOrRequest = (propertyKey: any, item: any) =>
          ...
          >
            ...
            >
              <SingleLineEditor
                ...
                theme={storedTheme}
                onChange={(newValue: any) => updateSetting('timeout', newValue)}
          ...
          >
            ...
            >
              <SingleLineEditor
                ...
                theme={storedTheme}
                onChange={(newValue: any) => updateSetting('keepAliveInterval', newValue)}
                collection={collection}
              />
            </ToolHint>
          </div>
