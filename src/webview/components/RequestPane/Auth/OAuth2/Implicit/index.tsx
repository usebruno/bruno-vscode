...
const OAuth2Implicit = ({
  ...
  const TokenPlacementIcon = forwardRef<HTMLDivElement>((props, ref) => {
    return (
  ...
  const handleAutoFetchTokenToggle = (e: React.ChangeEvent<HTMLInputElement>) => {
    handleChange('autoFetchToken', e.target.checked);
  };

  const handleUseSystemBrowserToggle = (e: React.ChangeEvent<HTMLInputElement> | { target: { checked: boolean } }) => {
      ...
      <div className="flex items-center gap-4 w-full" key="input-token-name">
        ...
        <div className="oauth2-input-wrapper flex-1">
          <SingleLineEditor
            ...
            theme={storedTheme}
            onSave={handleSave}
            onChange={(val: any) => handleChange('credentialsId', val)}
            onRun={handleRun}
            collection={collection}
            item={item}
            isCompact
        ...
        <div className="flex items-center gap-4 w-full" key="input-token-header-prefix">
          ...
          <div className="oauth2-input-wrapper flex-1">
            <SingleLineEditor
              ...
              theme={storedTheme}
              onSave={handleSave}
              onChange={(val: any) => handleChange('tokenHeaderPrefix', val)}
              onRun={handleRun}
              collection={collection}
              item={item}
              isCompact
        ...
        <div className="flex items-center gap-4 w-full" key="input-token-query-key">
          ...
          <div className="oauth2-input-wrapper flex-1">
            <SingleLineEditor
              ...
              theme={storedTheme}
              onSave={handleSave}
              onChange={(val: any) => handleChange('tokenQueryKey', val)}
              onRun={handleRun}
              collection={collection}
              item={item}
              isCompact
