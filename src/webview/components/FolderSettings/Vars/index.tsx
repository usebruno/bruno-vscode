...
const Vars = ({
  ...
  const requestVars = folder.draft ? get(folder, 'draft.root.request.vars.req', []) : get(folder, 'root.request.vars.req', []);
  const responseVars = folder.draft ? get(folder, 'draft.root.request.vars.res', []) : get(folder, 'root.request.vars.res', []);
