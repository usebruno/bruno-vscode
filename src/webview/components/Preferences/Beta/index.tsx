...
const Beta = ({
  ...
  const generateValidationSchema = () => {
    const schemaShape: Record<string, Yup.BooleanSchema> = {};
    BETA_FEATURES.forEach((feature: any) => {
  ...
  const handleSave = useCallback((newBetaPreferences: any) => {
    (dispatch(
      savePreferences({
        ...preferences,
      ...
      .catch((err: any) => { toast.error('Failed to update beta preferences'); });
    ...
    <StyledWrapper>
      <form className="bruno-form" onSubmit={formik.handleSubmit}>
        ...
        <div className="space-y-4">
          {BETA_FEATURES.map((feature: any) => <div key={feature.id} className="beta-feature-item">
