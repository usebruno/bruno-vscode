...
const CreateCollection = ({
  ...
  const workspaceUid = useSelector((state: RootState) => state.workspaces?.activeWorkspaceUid);
  ...
  const activeWorkspace = workspaces.find((w: any) => w.uid === workspaceUid) as any;
  ...
  const AdvancedOptions = forwardRef<HTMLDivElement>((props, ref) => {
    return (
