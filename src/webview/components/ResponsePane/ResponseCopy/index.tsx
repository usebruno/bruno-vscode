...
interface ResponseCopyRef {
  click: () => void;
  isDisabled: boolean;
}

const getTextToCopy = (selectedTab: any, selectedFormat: any, data: any, dataBuffer: any) => {
...
interface UseResponseCopyResult {
  copyResponse: () => void;
  copied: boolean;
  hasData: boolean;
}
...
export const useResponseCopy = (item: unknown, selectedFormat: unknown, selectedTab: unknown, data: unknown, dataBuffer: unknown): UseResponseCopyResult => {
...
const ResponseCopy = forwardRef<ResponseCopyRef, ResponseCopyProps>(({ item, children, selectedFormat, selectedTab, data, dataBuffer }, ref) => {
