...
interface ResponseDownloadRef {
  click: () => void;
  isDisabled: boolean;
}

interface ResponseDownloadProps {
  item: any;
...
const ResponseDownload = forwardRef<ResponseDownloadRef, ResponseDownloadProps>(({ item, children }, ref) => {
