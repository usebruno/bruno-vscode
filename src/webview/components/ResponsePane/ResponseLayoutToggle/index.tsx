...
interface UseResponseLayoutToggleResult {
  orientation: string;
  toggleOrientation: () => void;
}

// Hook to get orientation and toggle function
export const useResponseLayoutToggle = (): UseResponseLayoutToggleResult => {
  ...
  const toggleOrientation = () => {
    ...
    dispatch(savePreferences(updatedPreferences as any));
  };

  return { orientation, toggleOrientation };
};

interface ResponseLayoutToggleRef {
  click: () => void;
  isDisabled: boolean;
}
...
const ResponseLayoutToggle = forwardRef<ResponseLayoutToggleRef, ResponseLayoutToggleProps>(({ children }, ref) => {
