...
const ProxySettings = ({
  ...
  const validateHostnameOnChange = (hostname: any) => {
  ...
  const validatePortOnChange = (port: any) => {
    if (!port || port === '') {
  ...
  const validateAuthUsernameOnChange = (username: any) => {
  ...
  const validateAuthPasswordOnChange = (password: any) => {
  ...
  const validateBypassProxyOnChange = (bypassProxy: any) => {
  ...
  const handleAuthEnabledChange = (e: any) => {
    updateProxy({
      config: {
        ...currentProxyConfig.config,
        auth: {
  ...
  const handleAuthUsernameChange = (e: any) => {
  ...
  const handleAuthPasswordChange = (e: any) => {
  ...
  const handleBypassProxyChange = (e: any) => {
