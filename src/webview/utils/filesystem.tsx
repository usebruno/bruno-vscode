 ...
 */
export const existsSync = async (filePath: any) => {
 ...
 */
export const resolvePath = async (relativePath: any, basePath: any) => {
  return await window.ipcRenderer.invoke('renderer:resolve-path', relativePath, basePath);
};

export const browseDirectory = async (pathname: any) => {
 ...
 */
export const isDirectory = async (dirPath: any) => {
