...
export const deleteUidsInItems = (items: any) => {
  each(items, (item) => {
    delete item.uid;
 ...
 */
export const transformItem = (items: any[] = []) => {
  each(items, (item) => {
...
export const deleteUidsInEnvs = (envs: any) => {
  each(envs, (env) => {
    delete env.uid;
...
export const deleteSecretsInEnvs = (envs: any) => {
  each(envs, (env) => {
