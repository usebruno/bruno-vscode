...
const pathFoundInVariables = (path: any, obj: any) => {
 ...
 */
export const defineCodeMirrorBrunoVariablesMode = (_variables: any, mode: any, highlightPathParams: any, highlightVariables: any) => {
  CodeMirror.defineMode('brunovariables', function (config: any, parserConfig: any) {
...
export const getCodeMirrorModeBasedOnContentType = (contentType: any, body: any) => {
