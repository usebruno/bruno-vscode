...
export const getDefaultResponseFormat = (contentType: any) => {
...
export const isValidHtmlSnippet = (snippet: any) => {
 ...
 */
const decodeBase64Head = (base64: any, byteCount: any) => {
...
*/
export const detectContentTypeFromBuffer = (buffer: any) => {
 ...
 */
export const detectContentTypeFromBase64 = (base64: any) => {
