...
export const convertInsomniaToBruno = async (data: any) => {
  try {
    return await window.ipcRenderer.invoke('renderer:convert-insomnia-to-bruno', data);
  } catch (err: any) {
...
export const isInsomniaCollection = (data: any) => {
